...
// Fragment order (include/web_pages.h): ui_shell, ui_device, ui_agent, ui_memory, ui_wifi, ui_loops, ui_onboard, ui_js
inline const char* const kWebUiParts[] = {
  R"NIMBUSWEBUI(<!doctype html>
...
<div class=mact><button class=ghost id=modalCancel type=button>Cancel</button><button id=modalOk type=button>Confirm</button></div>
  ...
  R"NIMBUSWEBUI(<div class=pane id=pane-dash>
...
<p class=hint style="color:var(--crit)">Erases <b>everything</b> (Wi-Fi, API keys, the Telegram list, Bluetooth pairings, themes, sound settings, memory, the device name, and the device sign-in code), then restarts into first-time setup as a fresh device. This takes a few seconds, or up to a minute when erasing the card.</p>
  ...
  R"NIMBUSWEBUI(<div class=pane id=pane-harness style="display:none">
<div class=subtabs>
...
<div id=skillspanel></div>
  ...
  R"NIMBUSWEBUI(<div class=pane id=pane-chat style="display:none">
...
<p class=hint id=budmsg></p>
  ...
  R"NIMBUSWEBUI()NIMBUSWEBUI",
  R"NIMBUSWEBUI(<div class=pane id=pane-gov style="display:none">
...
<p class=hint id=modmsg></p>
  ...
  R"NIMBUSWEBUI(<div id=onbov style="display:none;position:fixed;inset:0;z-index:200;background:var(--bg);overflow-y:auto">
...
inline constexpr size_t kWebUiPartCount = sizeof(kWebUiParts) / sizeof(kWebUiParts[0]);

// The brand mark served at GET /logo.svg (favicon + sidebar orb), verbatim
// from include/web/ui_logo.h.
inline const char kLogoSvg[] = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 128 128\" role=\"img\" aria-label=\"Nimbus\"><circle cx=\"50.2\" cy=\"91.6\" r=\"4.1\" fill=\"#3BC9DB\" fill-opacity=\"0.72\"/><circle cx=\"43.3\" cy=\"87.4\" r=\"3.8\" fill=\"#0B7285\" fill-opacity=\"0.95\"/><circle cx=\"37.8\" cy=\"81.3\" r=\"4.0\" fill=\"#0B7285\" fill-opacity=\"0.91\"/><circle cx=\"33.7\" cy=\"74.1\" r=\"4.2\" fill=\"#0B7285\" fill-opacity=\"0.92\"/><circle cx=\"31.9\" cy=\"65.9\" r=\"4.4\" fill=\"#22B8CF\" fill-opacity=\"0.82\"/><circle cx=\"33.9\" cy=\"57.8\" r=\"3.8\" fill=\"#66D9E8\" fill-opacity=\"0.79\"/><circle cx=\"36.4\" cy=\"50.2\" r=\"3.9\" fill=\"#15AABF\" fill-opacity=\"0.98\"/><circle cx=\"40.4\" cy=\"43.0\" r=\"4.1\" fill=\"#3BC9DB\" fill-opacity=\"0.81\"/><circle cx=\"47.1\" cy=\"38.3\" r=\"4.2\" fill=\"#0B7285\" fill-opacity=\"0.92\"/><circle cx=\"54.1\" cy=\"34.3\" r=\"4.0\" fill=\"#15AABF\" fill-opacity=\"0.96\"/><circle cx=\"62.1\" cy=\"32.9\" r=\"3.9\" fill=\"#66D9E8\" fill-opacity=\"0.91\"/><circle cx=\"70.3\" cy=\"33.1\" r=\"4.2\" fill=\"#22B8CF\" fill-opacity=\"0.96\"/><circle cx=\"77.9\" cy=\"36.2\" r=\"4.0\" fill=\"#99E9F2\" fill-opacity=\"0.74\"/><circle cx=\"85.2\" cy=\"40.2\" r=\"3.8\" fill=\"#0F8A9D\" fill-opacity=\"0.95\"/><circle cx=\"90.5\" cy=\"46.5\" r=\"4.3\" fill=\"#66D9E8\" fill-opacity=\"0.87\"/><circle cx=\"93.6\" cy=\"54.2\" r=\"4.1\" fill=\"#3BC9DB\" fill-opacity=\"0.88\"/><circle cx=\"95.3\" cy=\"62.1\" r=\"4.1\" fill=\"#66D9E8\" fill-opacity=\"0.98\"/><circle cx=\"95.1\" cy=\"70.4\" r=\"4.2\" fill=\"#0B7285\" fill-opacity=\"0.97\"/><circle cx=\"92.8\" cy=\"78.4\" r=\"4.0\" fill=\"#66D9E8\" fill-opacity=\"0.79\"/><circle cx=\"87.7\" cy=\"85.1\" r=\"3.9\" fill=\"#0B7285\" fill-opacity=\"0.95\"/><circle cx=\"81.0\" cy=\"89.7\" r=\"3.8\" fill=\"#0B7285\" fill-opacity=\"0.98\"/><circle cx=\"73.8\" cy=\"93.4\" r=\"3.8\" fill=\"#15AABF\"/><circle cx=\"65.9\" cy=\"95.3\" r=\"4.3\" fill=\"#22B8CF\" fill-opacity=\"0.97\"/><circle cx=\"57.6\" cy=\"95.4\" r=\"4.0\" fill=\"#15AABF\" fill-opacity=\"0.94\"/><circle cx=\"94.1\" cy=\"37.2\" r=\"3.9\" fill=\"#0F8A9D\" fill-opacity=\"0.92\"/><circle cx=\"98.0\" cy=\"44.6\" r=\"3.9\" fill=\"#22B8CF\" fill-opacity=\"0.88\"/><circle cx=\"100.9\" cy=\"52.2\" r=\"4.1\" fill=\"#15AABF\" fill-opacity=\"0.94\"/><circle cx=\"104.1\" cy=\"60.0\" r=\"4.2\" fill=\"#3BC9DB\" fill-opacity=\"0.85\"/><circle cx=\"103.6\" cy=\"68.4\" r=\"4.3\" fill=\"#0B7285\"/><circle cx=\"102.1\" cy=\"76.6\" r=\"4.0\" fill=\"#66D9E8\" fill-opacity=\"0.82\"/><circle cx=\"97.6\" cy=\"83.6\" r=\"3.8\" fill=\"#3BC9DB\" fill-opacity=\"0.72\"/><circle cx=\"92.9\" cy=\"90.3\" r=\"3.8\" fill=\"#0F8A9D\" fill-opacity=\"0.93\"/><circle cx=\"86.6\" cy=\"95.4\" r=\"4.0\" fill=\"#0F8A9D\" fill-opacity=\"0.91\"/><circle cx=\"79.6\" cy=\"99.5\" r=\"3.9\" fill=\"#99E9F2\" fill-opacity=\"0.88\"/><circle cx=\"71.9\" cy=\"102.3\" r=\"3.8\" fill=\"#15AABF\" fill-opacity=\"0.94\"/><circle cx=\"63.8\" cy=\"104.1\" r=\"4.1\" fill=\"#99E9F2\" fill-opacity=\"0.84\"/><circle cx=\"55.7\" cy=\"102.0\" r=\"3.9\" fill=\"#0B7285\" fill-opacity=\"0.93\"/><circle cx=\"47.5\" cy=\"100.5\" r=\"4.4\" fill=\"#0F8A9D\" fill-opacity=\"0.9\"/><circle cx=\"40.6\" cy=\"95.9\" r=\"3.8\" fill=\"#0F8A9D\" fill-opacity=\"0.95\"/><circle cx=\"34.5\" cy=\"90.3\" r=\"4.2\" fill=\"#99E9F2\" fill-opacity=\"0.96\"/><circle cx=\"30.0\" cy=\"83.4\" r=\"4.3\" fill=\"#15AABF\" fill-opacity=\"0.92\"/><circle cx=\"26.3\" cy=\"76.0\" r=\"3.9\" fill=\"#66D9E8\" fill-opacity=\"0.8\"/><circle cx=\"24.2\" cy=\"68.0\" r=\"4.3\" fill=\"#99E9F2\" fill-opacity=\"0.96\"/><circle cx=\"24.2\" cy=\"59.6\" r=\"4.1\" fill=\"#66D9E8\" fill-opacity=\"0.77\"/><circle cx=\"26.7\" cy=\"51.7\" r=\"3.9\" fill=\"#0B7285\" fill-opacity=\"0.9\"/><circle cx=\"30.2\" cy=\"44.3\" r=\"4.0\" fill=\"#3BC9DB\"/><circle cx=\"34.2\" cy=\"36.9\" r=\"4.0\" fill=\"#99E9F2\"/><circle cx=\"41.2\" cy=\"32.3\" r=\"3.9\" fill=\"#0F8A9D\" fill-opacity=\"0.92\"/><circle cx=\"48.0\" cy=\"27.6\" r=\"4.1\" fill=\"#99E9F2\" fill-opacity=\"0.95\"/><circle cx=\"55.9\" cy=\"25.1\" r=\"4.2\" fill=\"#66D9E8\" fill-opacity=\"0.73\"/><circle cx=\"64.2\" cy=\"23.8\" r=\"4.1\" fill=\"#66D9E8\" fill-opacity=\"0.93\"/><circle cx=\"72.3\" cy=\"25.9\" r=\"4.3\" fill=\"#66D9E8\" fill-opacity=\"0.8\"/><circle cx=\"80.6\" cy=\"27.3\" r=\"4.4\" fill=\"#15AABF\" fill-opacity=\"0.94\"/><circle cx=\"87.6\" cy=\"31.9\" r=\"3.9\" fill=\"#0F8A9D\" fill-opacity=\"0.91\"/><circle cx=\"103.8\" cy=\"36.9\" r=\"4.4\" fill=\"#0F8A9D\" fill-opacity=\"0.98\"/><circle cx=\"107.6\" cy=\"44.3\" r=\"3.8\" fill=\"#15AABF\" fill-opacity=\"0.95\"/><circle cx=\"109.4\" cy=\"52.5\" r=\"4.1\" fill=\"#99E9F2\" fill-opacity=\"0.89\"/><circle cx=\"112.2\" cy=\"60.4\" r=\"4.3\" fill=\"#22B8CF\" fill-opacity=\"0.96\"/><circle cx=\"110.9\" cy=\"68.7\" r=\"3.9\" fill=\"#0F8A9D\" fill-opacity=\"0.93\"/><circle cx=\"109.9\" cy=\"77.0\" r=\"3.8\" fill=\"#0F8A9D\" fill-opacity=\"0.94\"/><circle cx=\"107.5\" cy=\"85.0\" r=\"4.1\" fill=\"#15AABF\" fill-opacity=\"0.95\"/><circle cx=\"103.2\" cy=\"92.2\" r=\"4.1\" fill=\"#15AABF\"/><circle cx=\"97.3\" cy=\"98.1\" r=\"4.0\" fill=\"#22B8CF\" fill-opacity=\"0.71\"/><circle cx=\"90.5\" cy=\"102.9\" r=\"3.9\" fill=\"#0B7285\" fill-opacity=\"0.98\"/><circle cx=\"83.5\" cy=\"107.4\" r=\"4.0\" fill=\"#3BC9DB\" fill-opacity=\"0.87\"/><circle cx=\"75.7\" cy=\"110.2\" r=\"3.8\" fill=\"#22B8CF\" fill-opacity=\"0.94\"/><circle cx=\"67.5\" cy=\"111.6\" r=\"4.3\" fill=\"#0F8A9D\" fill-opacity=\"0.93\"/><circle cx=\"59.2\" cy=\"111.4\" r=\"4.3\" fill=\"#22B8CF\" fill-opacity=\"0.93\"/><circle cx=\"51.1\" cy=\"109.7\" r=\"4.1\" fill=\"#3BC9DB\" fill-opacity=\"0.85\"/><circle cx=\"43.2\" cy=\"107.2\" r=\"4.1\" fill=\"#22B8CF\" fill-opacity=\"0.86\"/><circle cx=\"35.8\" cy=\"103.2\" r=\"4.4\" fill=\"#3BC9DB\" fill-opacity=\"0.96\"/><circle cx=\"30.2\" cy=\"96.9\" r=\"4.3\" fill=\"#22B8CF\" fill-opacity=\"0.98\"/><circle cx=\"25.1\" cy=\"90.5\" r=\"3.8\" fill=\"#0B7285\" fill-opacity=\"0.94\"/><circle cx=\"21.0\" cy=\"83.4\" r=\"4.3\" fill=\"#0B7285\" fill-opacity=\"0.97\"/><circle cx=\"17.2\" cy=\"75.9\" r=\"4.2\" fill=\"#0F8A9D\" fill-opacity=\"0.97\"/><circle cx=\"17.1\" cy=\"67.5\" r=\"3.9\" fill=\"#99E9F2\"/><circle cx=\"15.9\" cy=\"59.2\" r=\"4.4\" fill=\"#15AABF\" fill-opacity=\"0.95\"/><circle cx=\"17.7\" cy=\"50.9\" r=\"4.1\" fill=\"#0F8A9D\" fill-opacity=\"0.94\"/><circle cx=\"21.4\" cy=\"43.4\" r=\"4.2\" fill=\"#0F8A9D\" fill-opacity=\"0.93\"/><circle cx=\"26.0\" cy=\"36.7\" r=\"3.8\" fill=\"#22B8CF\" fill-opacity=\"0.83\"/><circle cx=\"31.0\" cy=\"30.1\" r=\"3.8\" fill=\"#3BC9DB\" fill-opacity=\"0.85\"/><circle cx=\"36.8\" cy=\"24.0\" r=\"3.8\" fill=\"#66D9E8\"/><circle cx=\"44.6\" cy=\"21.0\" r=\"3.9\" fill=\"#0B7285\" fill-opacity=\"0.98\"/><circle cx=\"52.4\" cy=\"18.5\" r=\"4.3\" fill=\"#22B8CF\" fill-opacity=\"0.97\"/><circle cx=\"60.5\" cy=\"16.9\" r=\"4.1\" fill=\"#0F8A9D\"/><circle cx=\"68.8\" cy=\"16.3\" r=\"4.2\" fill=\"#0B7285\" fill-opacity=\"0.91\"/><circle cx=\"76.9\" cy=\"18.3\" r=\"4.2\" fill=\"#0B7285\"/><circle cx=\"84.9\" cy=\"20.7\" r=\"3.8\" fill=\"#0B7285\"/><circle cx=\"92.2\" cy=\"24.9\" r=\"4.1\" fill=\"#22B8CF\" fill-opacity=\"0.8\"/><circle cx=\"98.6\" cy=\"30.3\" r=\"4.1\" fill=\"#15AABF\" fill-opacity=\"0.91\"/></svg>";
