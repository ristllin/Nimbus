...
// That is the v4.5.x regression on the classic solide_s3 board - the periodic
// panel reads (controller liveness, unchanged-frame health, the register/pixel
// probe) were all added after v4.4.6 and only ever validated on a Freenove, whose
// capacitive touch shares nothing with the panel bus.
//
