...
// 13 files, 177 sections, ~233 KB (from 223 KB of markdown).
#pragma once
...
| **Music tracks** | Web app: Memory & Files, Music (add, play, remove tracks on the card's music folder) | Device menu: not managed there; play from Telegram `/play` or the assistant. |)NIMBUSDOC"},
