...
// 13 files, 174 sections, ~228 KB (from 218 KB of markdown).
#pragma once
...
inline constexpr size_t kDocsSectionCount = 174;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"tools-and-commands", "Tools & Commands", 42, 13},
  {"hardware", "Nimbus Hardware Reference", 55, 14},
  {"turn-contract", "Orchestrator Turn Contract", 69, 14},
  {"sub-sessions", "Sub-sessions - the orchestrator's background agents, end to end", 83, 12},
  {"connectors", "Connectors - external tools, per provider", 95, 16},
  {"modes-and-signals", "Modes & signals - what the settings mean and what the device is telling you", 111, 15},
  {"led-ux", "The LED ring - motion & color language", 126, 11},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 137, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 153, 7},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 160, 8},
  {"notifier-status-language", "Notifier status language", 168, 6},
};
