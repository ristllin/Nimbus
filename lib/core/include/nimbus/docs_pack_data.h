...
// 13 files, 171 sections, ~218 KB (from 208 KB of markdown).
#pragma once
...
land where you touch.)NIMBUSDOC"},
  {"modes-and-signals#2-ring-level-what-the-ring-shows-in-each-mode-power-off", "2. Ring level - what the ring shows in each mode - Power off",
   R"NIMBUSDOC(**Settings > Power off** on the device (or **Power off** under Settings → Power
...
inline constexpr size_t kDocsSectionCount = 171;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"modes-and-signals", "Modes & signals - what the settings mean and what the device is telling you", 110, 13},
  {"led-ux", "The LED ring - motion & color language", 123, 11},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 134, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 150, 7},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 157, 8},
  {"notifier-status-language", "Notifier status language", 165, 6},
};
