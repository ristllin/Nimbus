...
// 13 files, 170 sections, ~217 KB (from 207 KB of markdown).
#pragma once
...
inline constexpr size_t kDocsSectionCount = 170;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"led-ux", "The LED ring - motion & color language", 122, 11},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 133, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 149, 7},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 156, 8},
  {"notifier-status-language", "Notifier status language", 164, 6},
};
