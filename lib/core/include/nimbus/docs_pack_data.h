...
// 13 files, 173 sections, ~224 KB (from 214 KB of markdown).
#pragma once
...
|---|---|---|
| **Directive** | Web app: setup wizard (Directive step) and the Directive box under Memory | Device menu: not editable there (free text; web-only) |)NIMBUSDOC"},
...
inline constexpr size_t kDocsSectionCount = 173;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"modes-and-signals", "Modes & signals - what the settings mean and what the device is telling you", 110, 15},
  {"led-ux", "The LED ring - motion & color language", 125, 11},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 136, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 152, 7},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 159, 8},
  {"notifier-status-language", "Notifier status language", 167, 6},
};
