...
// 13 files, 168 sections, ~213 KB (from 204 KB of markdown).
#pragma once
...
inline constexpr size_t kDocsSectionCount = 168;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"led-ux", "The LED ring - motion & color language", 122, 10},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 132, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 148, 6},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 154, 8},
  {"notifier-status-language", "Notifier status language", 162, 6},
};
