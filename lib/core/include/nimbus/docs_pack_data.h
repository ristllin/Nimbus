...
// 13 files, 172 sections, ~221 KB (from 211 KB of markdown).
#pragma once
...
| Header (`ring:/sound:/power:`) | `lib/core/src/tft_screens.cpp` `drawHeader` |)NIMBUSDOC"},
  // ---- led-ux ----
...
inline constexpr size_t kDocsSectionCount = 172;
...
inline constexpr DocFile kDocsFiles[] = {
  ...
  {"modes-and-signals", "Modes & signals - what the settings mean and what the device is telling you", 110, 14},
  {"led-ux", "The LED ring - motion & color language", 124, 11},
  {"memory", "Memory - the two RAM pools, the turn budget, and conversation compaction", 135, 16},
  {"turn-anatomy", "Turn anatomy - what the model actually sees, and how to inspect it raw", 151, 7},
  {"people-and-privacy", "People and privacy - roles, quotas, what stays private", 158, 8},
  {"notifier-status-language", "Notifier status language", 166, 6},
};
